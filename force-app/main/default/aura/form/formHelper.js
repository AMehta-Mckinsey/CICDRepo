...
this.updateTotal(component);
this.callexpenseList(component,expenses); 
...
$A.enqueueAction(action);
   ...
   callexpenseList : function(component, expense) {
       alert('here1111');
       var expenseListEvent = component.getEvent("getExpenseList");
       expenseListEvent.setParams({ "expense": expense }).fire();
   }    
